package
{
   ...
   public class Main extends Sprite
   {
      ...
      private var var_2717:Number = DevSettings.flags & DevSettings.DEVFLAG_MASTER_CLIENT ? 0 : 1;
      ...
      private function method_1284(param1:Event) : void
      {
         ...
         if(this.resourceMonitor)
         {
            ...
            timeSinceLastTick = mainTimeNow - this.var_2618;
            ...
            if(timeSinceFPSUpdate > 1000)
            {
               ...
               this.resourceMonitor.method_107("sbmp",SuperAnimData.var_263 * 4 / 1048576);
               this.resourceMonitor.method_107("bbmp",SuperAnimData.var_665 * 4 / 1048576);
               this.resourceMonitor.method_107("mcbmp",magicCacheCount * 4 / 1048576);
               this.resourceMonitor.method_107("tbmp",magicTilerCount * 4 / 1048576);
