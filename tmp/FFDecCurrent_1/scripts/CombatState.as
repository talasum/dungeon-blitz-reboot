package
{
   ...
   public class CombatState
   {
      ...
      private static const const_1146:Boolean = true;
      ...
      public function AddBuff(param1:BuffType, param2:Entity, param3:uint, param4:uint, param5:int = 1, param6:Vector.<class_140> = null, param7:int = 0, param8:Entity = null) : void
      {
         ...
         var _loc9_:Boolean = Entity.method_574(param2,this.var_3);
         if((_loc9_) && !param1.var_774 || !_loc9_ && param1.var_774)
         {
            return;
         }
         ...
         {
            _loc12_ = param2.summonerId ? this.var_1.GetEntFromID(param2.summonerId) : param2;
            if(_loc12_)
            {
      ...
      {
         var _loc2_:Buff = null;
         var _loc1_:* = int(this.var_84.length - 1);
         while(_loc1_ >= 0)
         {
      ...
      public function method_522(param1:BuffType, param2:uint, param3:uint, param4:uint, param5:uint, param6:Vector.<class_140>, param7:int = 0, param8:Entity = null) : void
      {
         ...
         var _loc9_:Entity = this.var_1.GetEntFromID(param2);
         var _loc10_:int = _loc9_ ? _loc9_.var_64 : 0;
         var _loc11_:Buff = this.method_135(param1);
         if(!_loc11_)
         {
            var _loc12_:PowerType = class_14.powerTypes[param5];
            var _loc13_:int = _loc12_ ? 0 : 0;
            ...
            {
               var _loc16_:int = int(param1.buffName.substring(9));
               _loc17_ = 4;
               if(this.var_2168)
               {
                  _loc17_ += 0.8;
               }
               var _loc18_:int = Math.floor(this.var_3.magicDamage * _loc17_);
            ...
            var _loc14_:int = param1.var_2950 + _loc11_.method_59("Durability");
            if(_loc14_)
            {
               if(_loc9_)
               {
                  _loc11_.var_1590 = 0 * _loc9_.magicDamage;
               }
            }
            if(param1.var_2030)
            {
            ...
            if(this.var_1.clientEntID != this.var_3.id)
            {
               ...
               {
                  this.var_3.method_262(true,true,0);
               }
               if(param1.buffName.indexOf("SentinelForm") == 0)
               {
                  this.var_3.method_247(true,true,0);
               }
               ...
               {
                  this.var_3.method_354(true,true,0);
               }
            }
      ...
      public function method_841() : void
      {
         ...
         var _loc2_:* = int(this.var_84.length - 1);
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_84[_loc2_];
            _loc5_ = _loc4_.type;
            if((Boolean(_loc5_)) && _loc5_.var_1378)
            {
               _loc1_.push(_loc5_);
            }
            _loc2_--;
      ...
      public function method_2127() : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_84[_loc2_];
            _loc5_ = _loc4_.type;
            if((Boolean(_loc5_)) && Boolean(_loc5_.var_1063))
            {
               _loc1_.push(_loc5_);
            }
            _loc2_--;
      ...
      public function method_72(param1:PowerType, param2:Entity, param3:Point, param4:int, param5:uint) : void
      {
         ...
         var _loc7_:ActivePower = new ActivePower(this.var_1,param1,this.var_3,param2,param3,0,0,0,false);
         _loc7_.var_803 = param4;
      ...
      private function method_1910(param1:PowerType) : Entity
      {
         ...
         {
            _loc6_ = this.var_1.GetPlayerEntFromEntName(_loc5_.charName);
            if(!(!_loc6_ || _loc6_.currHP <= 0))
            {
               _loc7_ = _loc6_.currHP / _loc6_.maxHP;
               if(_loc7_ <= _loc3_)
               {
      ...
      private function method_1513(param1:PowerType) : Entity
      {
         ...
         for each(_loc8_ in _loc7_)
         {
            if(!(Boolean(this.var_3.var_20 & Entity.PLAYER) && !this.var_1.PointOnScreenWithinDist(_loc8_.var_10,_loc8_.var_12,_loc8_.entType.width * 0.5,_loc8_.entType.height * 0.5)))
            {
               ...
               _loc9_ = _loc8_.appearPosX - this.var_3.appearPosX;
               _loc10_ = _loc9_ <= 0 && _loc5_ || _loc9_ >= 0 && !_loc5_;
      ...
      private function method_1322(param1:PowerType) : Entity
      {
         ...
         for each(_loc14_ in _loc6_)
         {
            if(!(Boolean(this.var_3.var_20 & Entity.PLAYER) && !this.var_1.PointOnScreenWithinDist(_loc14_.var_10,_loc14_.var_12,_loc14_.entType.width * 0.5,_loc14_.entType.height * 0.5)))
            {
               ...
               _loc21_ = _loc7_ ? int(_loc14_.entType.var_138 - _loc7_.entType.var_138) : 1;
      ...
      public function method_51(param1:PowerType, param2:Boolean, param3:uint = 0, param4:Point = null) : Boolean
      {
         ...
         if(this.var_39)
         {
            if(this.var_39 == class_14.powerTypesDict["SentinelForm1"].powerID)
            {
               ...
               {
                  _loc13_ = this.var_1.mTimeThisTick - this.var_1900 <= 250;
         ...
         {
            _loc14_ = this.var_3.var_24.method_375(class_36.const_1198);
            _loc15_ = _loc14_.x < this.var_3.appearPosX;
         ...
         {
            _loc17_ = this.var_1.mTimeThisTick - this.var_1900 <= 250;
            if(!_loc17_ || this.currMeleeCombo >= param1.var_1075)
            {
               this.currMeleeCombo = 0;
            }
            else
         ...
         {
            _loc18_ = this.var_1.mTimeThisTick - this.var_2624 <= 250 && (param1.powerName.indexOf("MeteorROR") == -1 && param1.basePowerName != "FlamethrowerROR");
            if(!_loc18_ || this.var_1502 >= param1.var_1212)
            {
               this.var_1502 = 0;
            }
            else
         ...
         var _loc10_:uint = param1.bIsProjectile ? uint(this.var_813++) : uint(0);
      ...
      public function method_414(param1:PowerType) : Boolean
      {
         if(this.var_3.var_18)
         {
            var _loc2_:int = this.var_3.var_18.method_102(this.var_3,param1.basePowerName,"ManaCost");
         }
         if(!this.var_3.brain && param1.var_219 && this.var_3.var_31 < param1.var_535 + 0)
         {
            return false;
         }
         var _loc3_:Number = 1 + this.var_1083;
         if(!this.var_3.brain && this.var_3.var_228 < int(_loc3_ * (param1.var_535 + 0)) && !param1.var_219 && !param1.var_749)
         {
            return false;
         }
         ...
         var _loc5_:PowerType = class_14.powerTypesDict["SentinelForm1"];
         if((_loc5_) && this.var_39 == _loc5_.powerID && (param1 == this.var_3.hudPowers[1] || param1 == this.var_3.hudPowers[2] || param1 == this.var_3.hudPowers[3] || param1.var_1439 || param1.var_749))
         {
            return false;
         }
      ...
      private function method_1192(param1:PowerType, param2:Entity, param3:Boolean, param4:uint, param5:Boolean, param6:uint, param7:Boolean, param8:int, param9:uint, param10:int = 0) : void
      {
         ...
         if(this.var_3.var_18)
         {
            var _loc18_:Number = this.var_3.var_18.method_102(this.var_3,param1.basePowerName,"BaseDamageMult");
         }
         _loc12_ += 0;
         var _loc19_:Boolean = false;
         var _loc20_:int = 0;
         ...
         else if(_loc12_ > 0)
         {
            ...
            if(_loc21_)
            {
               ...
               _loc30_ = param2.combatState.method_1552(param1);
               if(_loc30_ > 1)
               {
                  _loc30_ = 1;
               }
               ...
               _loc35_ = param2.entType;
               _loc36_ = _loc35_.entName;
               if(_loc36_ == "IntroDummy1")
               {
                  _loc21_ = param7 || _loc31_ ? int(_loc21_ * 2) : 1;
               }
               else if(_loc36_ == "IntroDummy2")
               {
                  _loc21_ = param1.manaCost == 20 ? int(_loc21_ * 2) : 1;
               }
               else if(_loc36_ == "IntroDummy3")
               {
                  _loc21_ = param1.manaCost == 30 ? int(_loc21_ * 2) : 1;
               }
               _loc37_ = param2.combatState.var_663;
               _loc37_ = _loc37_ + param2.combatState.var_1192;
               _loc38_ = 0;
               _loc38_ = _loc38_ + this.var_1738;
               if(param1.var_301)
               {
                  _loc37_ = 0;
                  _loc38_ = 0;
         ...
         {
            _loc21_ = Math.round(_loc12_ * this.var_3.magicDamage);
            _loc21_ = _loc21_ + Math.floor(this.var_3.totalMods.magicDamage * _loc21_);
            _loc21_ = _loc21_ + Math.floor(this.var_288 * _loc21_);
         ...
         var _loc22_:Boolean = Entity.method_574(this.var_3,param2);
         if((_loc22_) && _loc21_ < 0 || !_loc22_ && _loc21_ > 0)
         {
            return;
         }
         ...
         if(_loc24_)
         {
            if(!param1.var_2414 && (!param1.var_2451 || param6 == 1))
            {
               ...
               {
                  _loc52_ = class_14.buffTypesDict[_loc51_];
                  if(_loc52_)
                  {
                     if((!param1.var_1801 || param7) && (!param1.var_2273 || param4 == param1.var_108.length - 1) && (!param1.var_2369 || param4 == 0))
                     {
                        ...
                        _loc54_ = _loc52_.var_668 || _loc52_.var_953;
                        if(!_loc54_ || !param2.entType.var_2238)
                        {
                           if(_loc52_.var_2424)
                           {
                              _loc17_ = uint(param8);
            ...
            else if(param1.var_2414)
            {
               ...
               _loc52_ = class_14.buffTypesDict[_loc51_];
               if((_loc52_) && (!param1.var_1801 || param7) && (!param1.var_2273 || param4 == param1.var_108.length - 1) && (!param1.var_2369 || param4 == 0))
               {
                  if(this.var_3.var_18)
                  {
                     _loc16_ = this.var_3.var_18.method_101(this.var_3,_loc52_);
         ...
         if(_loc21_ > 0 && param1.var_2063 && (!param1.var_1682 || !param4))
         {
            ...
            if(_loc56_)
            {
               ...
               {
                  _loc57_ = class_14.buffTypesDict[_loc51_];
                  if(_loc57_)
                  {
                     if(this.var_3.var_18)
                     {
         ...
         _loc25_ = this.var_3.var_18.method_1479(_loc25_,param1.basePowerName,"ProcOnHit");
         if(_loc25_.length > 0)
         {
            for each(_loc63_ in _loc25_)
            {
               _loc64_ = class_14.powerTypesDict[_loc63_];
               if(_loc64_)
               {
         ...
         if(Boolean(this.var_1188) && _loc22_)
         {
            ...
            _loc69_ = !this.var_3.summonerId;
            _loc70_ = _loc69_ ? this.var_3.id : this.var_3.summonerId;
            _loc71_ = (Boolean(_loc70_)) && _loc70_ == this.var_1.clientEntID ? this.var_1.GetEntFromID(_loc70_) : null;
            if(_loc67_ && _loc68_ && _loc71_ && (_loc69_ || _loc71_.combatState.var_1815))
            {
               if(!_loc69_)
               {
                  _loc73_ = _loc71_.combatState.method_135(class_14.buffTypesDict["PlagueStackLimit"]);
                  if(_loc73_)
                  {
      ...
      public function method_1393(param1:int, param2:PowerType, param3:Entity) : Number
      {
         ...
         _loc6_ += _loc8_.meleeDamage;
         _loc6_ = _loc6_ + this.var_495;
         _loc9_ = Number(this.var_3.var_1562[_loc4_.var_106]);
         if(_loc9_)
         {
            _loc6_ += _loc9_;
         }
         _loc10_ = Number(this.var_3.var_65[_loc4_.var_328 + "Slay"]);
         if(_loc10_)
         {
            _loc6_ += _loc10_;
         }
         _loc11_ = Number(this.var_3.var_719[param2.var_157]);
         if(_loc11_)
         {
            _loc6_ += _loc11_;
         }
         _loc12_ = Number(param3.var_1516[this.var_3.entType.var_106]);
         if(_loc12_)
         {
            _loc6_ -= _loc12_;
         }
         var _loc13_:String = this.var_3.entType.var_103;
         _loc14_ = Number(param3.combatState.var_577[_loc13_]);
         if(_loc14_)
         {
            _loc6_ -= _loc14_;
         }
         _loc15_ = this.var_3.entType.var_328;
         _loc16_ = Number(param3.combatState.var_577[_loc15_]);
         if(_loc16_)
         {
            _loc6_ -= _loc16_;
         }
         _loc17_ = Number(param3.var_66["Resist" + _loc15_]);
         if(_loc17_)
         {
            _loc6_ -= _loc17_;
         }
         ...
         if((Boolean(_loc5_.var_1981) || Boolean(_loc5_.var_1786)) && (param2.var_402 == PowerType.DAMAGETYPE_FIRE || this.var_598))
         {
            ...
            _loc6_ += _loc20_ * _loc5_.var_1981;
            _loc6_ = _loc6_ + _loc21_ * _loc5_.var_1786;
         }
         ...
         if(param2.basePowerName == "ShadowBlade")
         {
            ...
            _loc32_ = _loc5_.var_1032 > _loc31_ ? _loc31_ : _loc5_.var_1032;
            if(_loc32_)
            {
               if(this.var_2400)
               {
         ...
         {
            _loc34_ = param3.combatState.var_84 ? param3.combatState.var_84.length : 0;
            if(_loc34_)
            {
               if(param2.var_7 >= 10)
               {
      ...
      public function method_294(param1:Entity, param2:int, param3:PowerType, param4:uint) : void
      {
         ...
         {
            _loc6_ = this.var_84.length - 1;
            while(_loc6_ >= 0)
            {
               _loc7_ = this.var_84[_loc6_];
               _loc8_ = _loc7_.type;
      ...
      public function method_225(param1:PowerType, param2:SuperAnimInstance, param3:uint, param4:Entity, param5:Point, param6:uint) : void
      {
         ...
         switch(param3)
         {
            ...
            case PowerType.ANIMSOURCE_GROUND:
               ...
               _loc15_ = _loc13_ ? Math.abs(_loc10_.y - _loc8_) : 10000;
               if(_loc15_ <= 200 && _loc15_ <= _loc14_)
               {
                  param5.x = _loc10_.x;
                  param5.y = _loc10_.y;
               }
      ...
      public function method_2045(param1:SuperAnimInstance, param2:PowerType, param3:Point) : void
      {
         ...
         {
            _loc4_ = Math.sqrt(Math.pow(param3.x - param1.m_TheDO.x,2) + Math.pow(param3.y - param1.m_TheDO.y,2));
            _loc5_ = _loc4_ / param2.method_63(this.var_3);
      ...
      public function method_512(param1:SuperAnimInstance, param2:PowerType, param3:Point) : void
      {
         ...
         {
            _loc4_ = new Point(param3.x - param1.m_TheDO.x,param3.y - param1.m_TheDO.y);
            _loc4_.normalize(1);
      ...
      public function method_884(param1:PowerType, param2:Entity, param3:uint) : void
      {
         ...
         if(Boolean(_loc4_) && (!param1.var_2927 || !param3))
         {
            ...
            _loc10_ = param1.powerName;
            if(!_loc10_.indexOf("ReduceArmor") || !_loc10_.indexOf("Enfeeble") || !_loc10_.indexOf("TouchHeal") || param1.var_301)
            {
      ...
      public function FireThisPower(param1:PowerType, param2:Point, param3:Array, param4:Boolean, param5:uint, param6:Boolean, param7:uint, param8:Dictionary, param9:int, param10:uint, param11:PowerGroup = null, param12:int = 0) : uint
      {
         ...
         {
            if(_loc15_.method_156() && (!param8 || !param8[_loc15_.id]))
            {
         ...
         if(_loc17_ && (!param1.var_1682 || !param5) && !param1.var_2063)
         {
            ...
            {
               _loc20_ = class_14.buffTypesDict[_loc19_];
               if(_loc20_)
               {
         ...
         if(param1.var_851 && (!param1.var_2629 || param5 == 0) || _loc18_ && this.var_3.mEquipPet)
         {
            ...
            while(_loc29_ < _loc28_)
            {
               ...
               _loc39_ = _loc33_.indexOf("ShadowLegionCloneTwo") == 0;
               _loc40_ = !_loc39_ && _loc33_.indexOf("ShadowLegionClone") == 0;
               ...
               else if(_loc40_ || _loc38_)
               {
                  ...
                  _loc23_ -= 30;
                  _loc50_ = this.method_139(new Point(_loc22_,_loc23_));
                  _loc22_ = _loc50_.x;
                  _loc23_ = _loc50_.y;
               }
               ...
               {
                  _loc52_ = this.method_139(new Point(_loc22_,_loc23_));
                  _loc22_ = _loc52_.x;
                  _loc23_ = _loc52_.y + Entity.PULLBACK_DIST;
               }
               _loc48_ = new Entity(this.var_1,_loc33_,null,_loc22_,_loc23_ - Entity.PULLBACK_DIST,Entity.LOCAL | Entity.MONSTER,this.var_3.team,0,0,this.var_3.id,param1,null,null,null,null,null);
               if(_loc48_)
               {
                  ...
                  {
                     _loc53_ = class_14.buffTypesDict[this.var_1574];
                     if(_loc53_)
                     {
      ...
      public function method_960() : void
      {
         ...
         while(_loc4_ >= 0)
         {
            _loc8_ = this.var_372[_loc4_];
            if(_loc8_.m_bFinished)
            {
         ...
         this.method_322();
         _loc5_ = this.var_554.length - 1;
         while(_loc5_ >= 0)
         {
            _loc9_ = this.var_554[_loc5_];
            if(!_loc9_.method_243())
            {
               _loc9_.method_129();
         ...
         if(this.mActivePower)
         {
            _loc10_ = this.mActivePower.powerType;
            if(_loc10_.damageMultFull > 0 && (_loc10_.manaCost || _loc10_.var_136 != "Melee"))
            {
               this.method_81();
            }
            if(!this.mActivePower.method_243())
            {
               ...
               if(_loc13_.var_543)
               {
                  _loc14_ = class_14.powerTypesDict[_loc13_.var_543];
                  if((Boolean(_loc14_)) && this.method_51(_loc14_,false))
                  {
         ...
         _loc7_ = this.var_84.length - 1;
         while(_loc7_ >= 0)
         {
            _loc16_ = this.var_84[_loc7_];
            if(!_loc16_.method_1095())
            {
               _loc16_.method_258();
         ...
         if(const_1146)
         {
            ...
            {
               _loc18_ = !this.var_3.brain ? int(Math.round((REGEN_AMOUNT + this.var_3.var_237 + this.var_546) * this.var_3.maxHP)) : int(Math.round(const_1217 * this.var_3.maxHP));
               if(_loc18_ + this.var_3.currHP > this.var_3.maxHP)
               {
               ...
               if(_loc18_)
               {
                  ...
                  {
                     _loc19_ = new Packet(LinkUpdater.const_958);
                     _loc19_.method_9(this.var_3.id);
            ...
            if(Boolean(this.var_937) && (!this.mActivePower || this.mActivePower.startTime))
            {
               if(this.masterDangerRegenInterval)
               {
                  if(!this.var_1392 && this.var_3.var_31 < this.var_1660)
                  {
                     ...
                     _loc20_ = new GfxType();
                     _loc20_.var_29 = "SFX_2.swf";
                     _loc20_.bFireAndForget = true;
                     _loc20_.animClass = "a_FrostShock";
                     _loc21_ = new SuperAnimInstance(this.var_1,_loc20_,true);
                     _loc21_.m_TheDO.x = this.var_3.appearPosX;
      ...
      public function method_304(param1:int = 5, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         {
            _loc4_ = _loc7_.type;
            if((Boolean(_loc4_)) && _loc4_.var_774)
            {
               _loc8_ = _loc4_.magicDamage < 0 || _loc4_.var_1597 < 0 || _loc4_.meleeDamage < 0 || _loc4_.var_1322 < 0;
               _loc9_ = Boolean(_loc4_.var_772);
               _loc10_ = _loc4_.var_1961 || _loc4_.bDisabled || _loc4_.var_876 || _loc4_.var_668 || _loc4_.var_953 || _loc4_.speedChange < 0;
               if((_loc10_) || _loc9_ && param2 || _loc8_ && param3)
               {
                  _loc5_.push(_loc4_);
                  _loc6_++;
      ...
      public function method_139(param1:Point) : Point
      {
         ...
         _loc2_ = new Point();
         _loc3_ = new Point();
         _loc4_ = this.var_1.collMan;
         var _loc5_:class_37 = _loc4_.getFloorCollision(0,param1.x,param1.y - 1,new Point(0,600),_loc2_,null,null,null,CollisionManager.HARD_FLOOR | CollisionManager.SOFT_FLOOR,0,0);
      ...
      public function method_390(param1:PowerType, param2:Number) : void
      {
         ...
         {
            var _loc4_:uint = _loc3_ - param1.coolDownTime;
            this.var_114[param1.powerID] = 0 + (1 - param2) * param1.coolDownTime;
         }
      }
