package
{
   ...
   public class Game
   {
      ...
      public static const const_501:uint = 8;
      ...
      public static const MELEEABLE:uint = 4;
      
      public static const FRIEND:uint = 8;
      
      public static const INTENTIONAL_MELEE:uint = 16;
      
      public static const ONLY_DEADGUYS:uint = 32;
      ...
      var _temp_1:* = const_85;
      const_21[const_550] = "necromancer";
      var _loc1_:String = "necromancer";
      _temp_1[_loc1_] = "Necromancer";
      ...
      internal var var_144:Array = new Array();
      
      internal var mOwnedGear:Array = new Array();
      
      internal var mOwnedGear2:Dictionary = new Dictionary();
      
      internal var mFilteredOwnedGear:Array = new Array();
      
      internal var mGearsetList:Vector.<Vector.<uint>> = new Vector.<Vector.<uint>>();
      
      internal var mGearsetListName:Vector.<String> = new Vector.<String>();
      ...
      internal var mOwnedMaterials:Array = new Array();
      
      internal var mOwnedCharms:Array = new Array();
      ...
      internal var mOwnedMounts:Array = new Array();
      ...
      internal var var_1918:Array = new Array();
      
      internal var var_1791:GlowFilter = new GlowFilter(11701805,1,1,1,10);
      ...
      public function method_1435() : void
      {
         ...
         var _loc6_:MovieClip = class_4.method_16("a_EdgeFull");
         _loc6_.visible = true;
         ...
         var _loc7_:Number = this.main.overallScale;
      ...
      public function method_571() : void
      {
         ...
         if(this.edgeLayer)
         {
            _loc8_ = this.edgeLayer.getChildByName("am_EdgeFull") as DisplayObject;
            if(_loc8_)
            {
               _loc8_.visible = true;
            }
            _loc9_ = this.edgeLayer.getChildByName("am_EdgeNarrow") as DisplayObject;
            if(_loc9_)
            {
      ...
      public function method_1938() : void
      {
         ...
         var _loc2_:uint = _loc1_ - this.mTimeThisTick;
      ...
      private function method_936(param1:String, param2:Boolean, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = false;
            _loc6_ = _loc4_.method_1251(param1);
            if(_loc6_)
            {
      ...
      public function method_1464(param1:String) : void
      {
         ...
         var _loc6_:String = this.level.internalName;
         if(_loc6_ == "NewbieRoad")
         {
      ...
      public function SelectMissionToTrack(param1:class_13 = null) : void
      {
         ...
         {
            _loc4_ = this.level.internalName;
      ...
      public function SetNewTutorialStage(param1:uint) : void
      {
         if(this.mTutorialStage != param1)
         {
            ...
            var _loc2_:String = const_727[param1];
            var _loc3_:Point = const_662[param1];
            this.var_655.method_290(const_480[param1],null);
      ...
      public function method_527(param1:int, param2:Number, param3:Number, param4:uint, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean = false, param9:uint = 0) : void
      {
         ...
         var _loc12_:Number = const_950;
         var _loc13_:Number = param5 ? 1.04 : 0.8;
         if(param8)
         {
            _loc13_ = 1.2000000000000002;
         }
         var _loc14_:class_72 = new class_72(this,_loc11_ + param1.toString(),param2,param3 - _loc12_,param4,_loc13_,true,null,null,param9);
         if(param8)
         {
      ...
      public function GatherEntities(param1:Entity, param2:Number, param3:Number, param4:Number, param5:Number, param6:uint) : Array
      {
         ...
         var _loc11_:* = param6 & ENEMY;
         var _loc12_:* = param6 & FRIEND;
         var _loc13_:Boolean = !_loc11_ && !_loc12_;
         ...
         var _loc23_:uint = Entity.const_6;
         var _loc24_:Boolean = Boolean(param6 & ONLY_DEADGUYS);
         var _loc25_:Boolean = Boolean(param6 & INTENTIONAL_MELEE);
         for each(_loc26_ in this.entities)
         {
            _loc18_ = _loc26_.entType.width * 0.5;
            _loc19_ = _loc26_.appearPosX - _loc18_;
            if(_loc19_ <= _loc15_)
            {
               _loc20_ = _loc26_.appearPosX + _loc18_;
               if(_loc20_ >= _loc14_)
               {
                  _loc22_ = _loc26_.appearPosY;
                  if(_loc22_ >= _loc16_)
                  {
                     _loc21_ = _loc26_.appearPosY - _loc26_.entType.height;
                     if(_loc21_ <= _loc17_)
                     {
                        if(!(!_loc25_ && _loc26_.behaviorType.var_1225))
                        {
                           if(_loc26_.method_156())
                           {
                              _loc9_ = _loc26_.entState == _loc23_;
                              if(_loc9_ == _loc24_)
                              {
                                 _loc10_ = param1.team != _loc26_.team && _loc26_.team != Entity.NEUTRAL;
                                 if(_loc13_ || _loc11_ && _loc10_ || _loc12_ && !_loc10_)
                                 {
                                    _loc8_.push(_loc26_);
                                 }
                              }
      ...
      public function method_2135(param1:Point, param2:Number) : Vector.<class_130>
      {
         ...
         {
            _loc6_ = _loc5_.var_11.subtract(param1);
      ...
      public function method_2120(param1:Entity, param2:Point, param3:Number, param4:uint) : Vector.<class_130>
      {
         ...
         {
            _loc12_ = _loc11_.var_11.subtract(param2);
            _loc13_ = _loc12_.x * _loc12_.x + _loc12_.y * _loc12_.y;
            if(_loc13_ < _loc10_)
            {
               var _loc8_:Boolean = param1.team != _loc11_.var_19.team && _loc11_.var_19.team != Entity.NEUTRAL;
               if(_loc6_)
               {
                  _loc9_.push(_loc11_);
               }
      ...
      public function method_885(param1:KeyboardEvent) : void
      {
         ...
         var _loc3_:int = int(this.var_406.indexOf(_loc2_));
         if(_loc3_ != -1)
         {
      ...
      public function method_668(param1:uint) : void
      {
         ...
         var _loc4_:String = _loc3_.characterName;
         if(!_loc4_)
         {
            return;
         }
         ...
         {
            _loc5_ = new Packet(LinkUpdater.PKTTYPE_TALK_TO_NPC);
            _loc5_.method_9(_loc2_.id);
         ...
         {
            _loc6_ = "";
            _loc7_ = this.mBuildingInfo.mWorkerBuildingID;
            _loc8_ = class_14.var_278[_loc7_];
            _loc8_ = this.mBuildingInfo.method_256(_loc8_);
            if(_loc8_)
            {
               _loc8_ = class_9.method_132(_loc8_);
               _loc6_ = _loc8_.type;
            }
            if(_loc4_ == "Special_CraftForge")
            {
               _loc9_ = this.mBuildingInfo.GetOwnedBuildingByName("Forge");
               if(_loc9_.rank == 0 && _loc6_ != "Forge")
               {
                  ...
                  else
                  {
                     ...
                     _loc10_ = this.mBuildingInfo.UpgradeBuilding(_loc9_);
                     if(_loc10_)
                     {
            ...
            {
               _loc11_ = this.mBuildingInfo.GetOwnedBuildingByName("Tome");
               if(_loc11_.rank == 0 && _loc6_ != "Tome")
               {
                  if(_loc8_)
                  {
                     this.screenChat.ReceiveChat(0,"The workers are busy upgrading the " + _loc8_.displayName,false);
                  ...
                  _loc10_ = this.mBuildingInfo.UpgradeBuilding(_loc11_);
                  if(_loc10_)
                  {
                     this.screenUpgrading.Display(_loc10_);
                  }
            ...
            {
               _loc12_ = this.mBuildingInfo.GetOwnedBuildingByName("Barn");
               if(_loc12_.rank == 0 && _loc6_ != "Barn")
               {
                  ...
                  else
                  {
                     ...
                     _loc10_ = this.mBuildingInfo.UpgradeBuilding(_loc12_);
                     if(_loc10_)
                     {
                        this.screenUpgrading.Display(_loc10_);
                     }
      ...
      public function method_867(param1:Entity, param2:String, param3:Door) : void
      {
         ...
         for each(_loc4_ in this.level.targetList)
         {
            if(_loc4_.localTarget == param2 && _loc4_ != param3)
            {
               ...
               _loc5_ = _loc4_.posX;
               _loc6_ = _loc4_.posY;
               _loc7_ = this.collMan.getFloorCollision(0,_loc4_.posX,_loc4_.posY - 10,new Point(0,80),var_1484,null,null,null,CollisionManager.HARD_FLOOR | CollisionManager.SOFT_FLOOR,0);
               if(_loc7_)
               {
                  _loc5_ = var_1484.x;
      ...
      public function method_702(param1:KeyboardEvent) : void
      {
         ...
         if(this.mKeybindManager.mbStatePickKey)
         {
            ...
            {
               var _loc4_:int = this.mKeybindManager.method_32(this.mKeybindManager.mActiveCommand,_loc3_,true,true);
         ...
         switch(_loc2_)
         {
            ...
            case Game.const_329:
               if(!this.screenInteractiveTutorial.method_134())
               {
                  _loc5_ = this.level.internalName;
                  _loc6_ = Boolean(this.mMissionInfoList[class_13.const_118]) || _loc5_ != "NewbieRoad";
                  _loc7_ = this.level.var_333;
                  _loc8_ = !_loc7_ && this.level.bInstanced;
            ...
            case Game.const_277:
               if(Boolean(this.clientEnt) && Boolean(this.clientEnt.mEquipPet))
               {
                  ...
                  _loc12_ = class_14.powerTypesDict[this.clientEnt.mEquipPet.mPetType.var_1138];
                  if(_loc12_)
                  {
      ...
      public function method_2000() : void
      {
         ...
         {
            var _loc1_:Object = this.var_164.data;
      ...
      {
         var _loc1_:Number = this.main.overallScale;
         if(this.var_1419)
         {
      ...
      public function method_1312() : void
      {
         ...
         if(Boolean(this.serverConn) && Boolean(this.linkUpdater))
         {
            if(Boolean(this.var_1909) && Boolean(this.var_1447) && Boolean(this.var_1257))
            {
               ...
               {
                  _loc5_ = parseInt(this.var_1909.charAt(_loc3_),16);
                  _loc6_ = parseInt(this.var_1257.charAt(_loc3_),16);
                  _loc7_ = uint(_loc5_ ^ _loc6_);
                  _loc2_ += _loc7_.toString(16);
                  _loc3_++;
               }
               _loc4_ = new Packet(_loc1_);
               _loc4_.method_26(this.clientFacebookID);
            ...
            {
               _loc9_ = new Packet(LinkUpdater.PKTTYPE_LOGIN_CHARACTER_SELECT);
               _loc9_.method_26(this.var_1125);
      ...
      private function method_1970() : void
      {
         ...
         var _loc4_:* = int(this.entities.length);
         _loc1_ = 0;
         while(_loc1_ < _loc4_)
         {
         ...
         var _loc6_:* = int(this.var_371.length);
         _loc1_ = 0;
         while(_loc1_ < _loc6_)
         {
            _loc5_ = this.var_371[_loc1_];
            if(!_loc5_.TickMissile())
            {
               _loc5_.method_770();
         ...
         var _loc8_:* = int(this.var_326.length);
         _loc1_ = 0;
         while(_loc1_ < _loc8_)
         {
            _loc7_ = this.var_326[_loc1_];
            if(!_loc7_.method_1300())
            {
               _loc7_.method_946();
         ...
         var _loc11_:* = int(this.var_532.length);
         _loc1_ = 0;
         while(_loc1_ < _loc11_)
         {
            _loc10_ = this.var_532[_loc1_];
            if(!_loc10_.method_1939() || _loc9_ && !_loc10_.var_1344)
            {
               _loc10_.method_963();
      ...
      public function method_2134() : void
      {
         ...
         while(_loc3_ < _loc5_)
         {
            ...
            var _temp_3:* = _loc6_;
            _loc6_.var_1053 = 2000000;
            _temp_3.var_847 = 2000000;
            _loc6_.var_514 = 0;
         ...
         if(_loc5_ != _loc4_)
         {
            var _loc7_:class_72 = new class_72(this,String(_loc4_ - _loc5_) + " more errors...",Camera.SCREEN_WIDTH * 0.5,_loc1_,16724787,0.5,false);
            var _temp_5:* = _loc7_;
            var _loc8_:int;
            _loc7_.var_1053 = _loc8_ = 2000000;
            _temp_5.var_847 = 2000000;
            null.var_514 = 0;
            this.var_532.push(null);
            _loc1_ += 15;
         }
         class_24.method_680();
      ...
      public function method_1649(param1:int, param2:String, param3:uint, param4:uint, param5:uint, param6:uint, param7:class_118, param8:String, param9:uint, param10:Vector.<class_87>) : void
      {
         ...
         _loc11_ = Level.method_73(this.level.internalName);
         if(_loc11_)
         {
         ...
         if(this.edgeLayer)
         {
            _loc12_ = this.edgeLayer.getChildByName("am_EdgeFull") as DisplayObject;
            if(_loc12_)
            {
               _loc12_.visible = false;
            }
            _loc13_ = this.edgeLayer.getChildByName("am_EdgeNarrow") as DisplayObject;
            if(_loc13_)
            {
         ...
         if(!(DevSettings.DEVFLAG_NO_PLAYERENT & DevSettings.flags))
         {
            ...
            {
               _loc14_ = this.level.var_1269.x;
               _loc15_ = this.level.var_1269.y;
            }
            else if(this.level.var_239)
            {
               _loc14_ = this.level.var_239.x;
               _loc15_ = this.level.var_239.y;
            }
            if(this.targetDoor)
            {
            ...
            this.var_1025 = null;
            _loc16_ = new Point();
            _loc17_ = this.collMan.getFloorCollision(0,_loc14_,_loc15_ - 59,new Point(0,160),_loc16_,null,null,null,CollisionManager.HARD_FLOOR | CollisionManager.SOFT_FLOOR,0);
            if(_loc17_)
            {
               _loc14_ = _loc16_.x;
            ...
            if(_loc18_ && _loc18_.room && _loc18_ == _loc19_)
            {
               ...
               {
                  _loc39_ = this.level.var_264[0];
                  _loc14_ = _loc39_.posX;
            ...
            _loc20_ = this.level.internalName ? Level.method_182(this.level.internalName) : null;
            _loc21_ = _loc20_ == "ShazariDesert" || _loc20_ == "JadeCity" || _loc20_ == "ShazariDesertHard" || _loc20_ == "JadeCityHard";
      ...
      public function method_1737(param1:DisplayObjectContainer) : void
      {
         ...
         while(_loc3_ < param1.numChildren)
         {
            ...
            if(_loc4_ is a_Cue)
            {
               _loc6_ = _loc4_ as a_Cue;
            }
            if(_loc4_ is DisplayObjectContainer)
            {
               this.method_1737(_loc4_ as DisplayObjectContainer);
            }
            _loc3_++;
         }
      }
      ...
      public function GetScreenShotHTML() : String
      {
         ...
         _loc4_ = new BitmapData(_loc2_ * const_403,_loc3_ * const_403,false,4737365);
         _loc4_.drawWithQuality(_loc1_,const_908,null,null,null,false,StageQuality.HIGH);
      ...
      public function method_1852() : void
      {
         ...
         {
            _loc1_ = this.level.levelName;
            _loc2_ = this.level.mapLevel;
            _loc3_ = this.level.baseLevel;
            _loc4_ = this.level.internalName;
            _loc5_ = this.level.momentParamsString;
            _loc6_ = this.level.alterParamsString;
            _loc7_ = this.level.bInstanced;
            this.method_447();
      ...
      public function method_1946() : void
      {
         ...
         if(this.gameState == STATE_PLAY && (!_loc1_ || !this.var_1778))
         {
            ...
            _loc9_ = this.var_1040.numChildren;
            _loc8_ = 0;
            while(_loc8_ < _loc9_)
            {
               _loc3_ = this.var_1040.getChildAt(_loc8_) as Sprite;
               if(_loc3_.visible)
               {
                  ...
                  {
                     _loc10_ = _loc3_;
                     _loc12_ = _loc10_.numChildren;
                     _loc11_ = 0;
                     while(_loc11_ < _loc12_)
                     {
                        _loc13_ = _loc10_.getChildAt(_loc11_) as Sprite;
                        if(_loc13_.visible)
                        {
                           _loc14_ = _loc13_.transform.matrix;
                           _loc14_.concat(_loc6_);
                           if(_loc13_ == this.var_107.var_343)
                           {
                              _loc15_ = _loc13_;
                              _loc16_ = new Matrix();
                              _loc16_.tx = (_loc10_.x + _loc15_.x) * this.main.overallScale;
                              _loc16_.ty = (_loc10_.y + _loc15_.y) * this.main.overallScale;
                              _loc4_.drawWithQuality(_loc15_,_loc16_,null,null,null,false,StageQuality.HIGH);
                           }
                           else if(_loc13_ == this.playerEntLayer)
                           {
                              _loc4_.drawWithQuality(_loc13_,_loc14_,null,null,null,false,StageQuality.HIGH);
                           }
                           else
                           {
                              _loc4_.drawWithQuality(_loc13_,_loc14_,null,null,null,false,StageQuality.HIGH);
      ...
      public function RenderGear(param1:String, param2:GearType, param3:Number = 1, param4:Entity = null, param5:class_21 = null, param6:class_21 = null, param7:Boolean = false) : SuperAnimInstance
      {
         ...
         _loc8_ = param4 ? param4 : this.clientEnt;
         _loc9_ = _loc8_.entType;
         _loc10_ = _loc9_.equippedGear[_loc11_];
         ...
         _loc15_ = new SuperAnimInstance(this,_loc14_,true,!param7);
         _loc15_.m_Seq.method_34(Seq.C_USEPOWER,_loc13_,true);
         _loc15_.method_105();
         return _loc15_;
      }
      ...
      public function method_1412(param1:DisplayObjectContainer) : void
      {
         ...
         _loc3_ = param1 ? uint(param1.numChildren) : uint(0);
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      public function method_2090(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            _loc5_ = Number(this.var_1918[param1]);
            if(_loc5_)
            {
      ...
      public function method_195(param1:String = null) : void
      {
         ...
         for each(_loc4_ in this.entities)
         {
            ...
            if(_loc2_)
            {
               _loc5_ = _loc2_.characterName;
               if(_loc5_)
               {
                  if(!(Boolean(param1) && _loc5_ != param1))
                  {
                     _loc6_ = class_14.var_999[_loc5_];
                     if(_loc6_)
                     {
      ...
      public function method_1472(param1:uint, param2:uint, param3:uint) : void
      {
         ...
         _loc4_ = class_14.var_238[param1];
         if(!_loc4_)
         {
            return;
         }
         _loc5_ = this.mMissionInfoList[param1];
         if(_loc5_)
         {
         ...
         if(_loc4_.var_1775)
         {
            ...
            _loc7_ = new class_72(this,"",Camera.SCREEN_WIDTH * 0.5,220,0,1,false,_loc6_,null);
            _loc7_.var_514 = 0;
            _loc7_.var_847 = 3500;
      ...
      public function method_1873(param1:uint, param2:uint) : void
      {
         ...
         _loc4_ = this.mMissionInfoList[param1];
         if(!_loc4_)
         {
            return;
         }
      ...
      public function method_1916(param1:Entity, param2:a_Cue, param3:String) : void
      {
         ...
         _loc4_ = null;
         _loc5_ = class_14.var_999[param3];
         if(_loc5_)
         {
      ...
      public function method_1657(param1:Vector.<uint>) : void
      {
         ...
         while(_loc2_ < _loc3_.length)
         {
            ...
            if(_loc6_)
            {
               var _loc7_:uint = uint(this.var_144.indexOf(_loc6_));
               if(_loc7_ > -1)
               {
                  this.var_144.splice(0,1);
      ...
      public function method_709() : void
      {
         ...
         _loc2_ = 0;
         _loc3_ = 0;
         _loc4_ = this.var_144.length - 1;
         _loc5_ = _loc4_ - ScreenArmory.const_12 >= 0 ? int(_loc4_ - ScreenArmory.const_12) : 0;
         _loc6_ = 0;
         ...
         while(_loc4_ >= 0)
         {
            ...
            while(_loc1_ >= _loc5_)
            {
               if(_loc1_ < _loc7_ - this.var_898 - this.var_1081)
               {
                  ...
                  _loc10_ = _loc6_ == 0 ? uint(this.var_898 + this.var_1081) : uint(_loc6_ * ScreenArmory.const_12);
                  _loc10_ = _loc10_ + _loc2_;
                  if(_loc8_)
                  {
                     _loc9_ = _loc8_.gearType;
                     if(_loc9_.var_8 == "L")
                     {
      ...
      public function HasBetterOrEven(param1:GearType) : Boolean
      {
         ...
         _loc4_ = this.GetBestOwnedGearByID(_loc3_);
         if(!_loc4_)
         {
            return _loc2_;
         }
      ...
      public function UpdateBuildingUpgradePanel(param1:MovieClip, param2:class_9, param3:class_33) : void
      {
         ...
         if(param2)
         {
            _loc8_ = param2.rank + 1;
            _loc14_ = class_9.method_94(param2.var_242,_loc8_);
            _loc5_ = param2.displayName;
            if(!_loc14_)
            {
            ...
            {
               _loc6_ = _loc14_.var_129;
               _loc7_ = _loc14_.upgradeTime;
               param1.am_MaxRank.visible = false;
               param1.am_Arrow.visible = true;
            }
         }
         MathUtil.method_2(param1.am_Name,_loc5_);
         var _loc10_:* = false;
         _loc11_ = 0;
         _loc12_ = false;
         if(this.clientEnt)
         {
            _loc10_ = this.clientEnt.currGold >= _loc6_;
            _loc11_ = class_105.method_551(this.clientEnt.mExpLevel);
         }
         if(_loc9_)
         {
         ...
         {
            MathUtil.method_8(param1.am_Time,Game.method_70(_loc7_,true),ScreenArmory.const_11,ScreenArmory.const_59);
            MathUtil.method_8(param1.am_Gold,MathUtil.method_29(_loc6_),ScreenArmory.const_11,ScreenArmory.const_59);
         }
         _loc13_ = param2.var_1499;
         if(!_loc14_)
         {
            _loc12_ = true;
         }
         else if(_loc11_ < _loc8_)
         {
            _loc13_ = "Must be level " + (_loc8_ - 1) * 5 + " to upgrade";
            _loc12_ = true;
         }
         else if(this.mBuildingInfo.mStatus != class_105.const_29)
         {
            _loc15_ = this.mBuildingInfo.GetCurrentBuilding();
            if(_loc15_)
            {
               _loc13_ = "Busy upgrading " + _loc15_.displayName;
            }
            _loc12_ = true;
         }
         if(_loc12_)
         {
            param3.Hide();
            MathUtil.method_8(param1.am_Message,_loc13_,ScreenArmory.const_137,ScreenArmory.const_169);
         }
         else
         {
            param3.Show();
            MathUtil.method_8(param1.am_Message,_loc13_,ScreenArmory.const_106,ScreenArmory.const_417);
         }
      }
      ...
      public function method_1838(param1:Boolean = false, param2:uint = 7, param3:uint = 0) : void
      {
         ...
         if(this.mTimeThisTick > this.var_2724 + const_1135)
         {
            ...
            _loc4_ = new Packet(LinkUpdater.const_1099);
            _loc4_.method_24(this.clientEnt.currHP);
      ...
      public function GainCharm(param1:class_64, param2:Boolean) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               var _loc4_:class_114 = this.mOwnedCharms[param1.method_75()];
               if(!_loc4_)
               {
                  _loc4_ = new class_114(0,param1);
                  this.mOwnedCharms[param1.method_75()] = null;
               }
               else
               {
                  param1.method_266();
      ...
      public function method_1202(param1:class_3, param2:uint, param3:Boolean) : void
      {
         ...
         var _loc5_:String = null;
         _loc4_ = this.mOwnedConsumables[param1.consumableID];
         if(!_loc4_)
         {
      ...
      public function QueuePotion(param1:class_3, param2:Boolean = true) : void
      {
         ...
         _loc3_ = param1 ? param1.consumableID : uint(0);
         _loc4_ = new Packet(LinkUpdater.const_909);
         _loc4_.method_20(class_3.const_69,_loc3_);
         this.serverConn.SendPacket(_loc4_);
         if(!this.clientEnt.mCurrPotion)
         {
            _loc5_ = param1 ? param1.consumableID : uint(0);
            this.clientEnt.method_190(this.clientEnt.mNextPotion);
            _loc6_ = new Packet(LinkUpdater.const_252);
            _loc6_.method_9(this.clientEntID);
