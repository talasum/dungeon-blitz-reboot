package
{
   ...
   public class Level
   {
      ...
      private static const const_336:uint = 1;
      
      private static const const_592:uint = 2;
      
      private static const const_305:uint = 4;
      ...
      private static const const_919:Boolean = true;
      ...
      internal var var_1046:Dictionary = new Dictionary();
      
      internal var var_1690:Dictionary = new Dictionary();
      
      internal var var_456:Dictionary = new Dictionary();
      ...
      public function method_1853(param1:String, param2:uint, param3:uint, param4:String, param5:String, param6:String, param7:Boolean) : void
      {
         ...
         this.levelSymbolName = _loc8_.length > 1 ? _loc8_[1] : "a_Level";
      ...
      public function method_1195() : Boolean
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            else if(!_loc10_.indexOf("a_Room_"))
            {
               ...
               if(Boolean(_loc11_) && Boolean(_loc11_.hasOwnProperty("InitRoom")))
               {
               ...
               _loc13_ = MathUtil.method_138(_loc11_,_loc11_);
               if(_loc13_)
               {
            ...
            else if(!_loc10_.indexOf("a_LevelDirector"))
            {
               ...
               this.var_2526 = _loc10_.substr(16);
               _loc9_.visible = const_30;
            }
         ...
         for(_loc3_ in this.var_1.collMan.var_259)
         {
            ...
            for each(_loc1_ in _loc11_)
            {
               if(_loc1_.var_573)
               {
                  ...
                  {
                     _loc13_ = _loc12_.split("_");
                     _loc14_ = _loc13_[0];
                     if(_loc14_ == "DoorLocal")
                     {
                        _loc15_ = _loc13_[1];
                        _loc2_[_loc15_] = true;
                     }
      ...
      public function method_923(param1:DisplayObject) : Boolean
      {
         ...
         for each(_loc6_ in _loc5_)
         {
            ...
            {
               _loc4_ = int(_loc6_.lastIndexOf("_"));
      ...
      public function method_232(param1:Sprite, param2:Room, param3:int, param4:uint, param5:String, param6:String) : void
      {
         ...
         var _loc11_:String = param1.name;
         if((Boolean(_loc11_)) && !_loc11_.indexOf("am_"))
         {
            param5 = _loc11_;
         }
         ...
         while(_loc13_ < param1.numChildren)
         {
            ...
            else if(!_loc15_.indexOf("a_CameraTarget"))
            {
               ...
               _loc24_ = uint(_loc23_[2]);
               if(_loc24_ == Room.const_243)
               {
            ...
            else
            {
               ...
               {
                  _loc26_ = param2.var_854[_loc16_];
                  if(!_loc26_)
                  {
                     _loc26_ = new Array();
               ...
               {
                  _loc27_ = ResourceManager.const_40[this.levelFileName];
                  _loc28_ = _loc27_.applicationDomain;
                  _loc29_ = _loc14_ as Sprite;
                  _loc30_ = _loc15_.split("_");
                  _loc31_ = _loc30_[1] == "Swap";
                  _loc32_ = _loc30_[2];
                  _loc33_ = null;
                  if(_loc31_)
                  {
                     _loc34_ = this.var_1.var_163[_loc32_];
                     if(_loc34_)
                     {
                  ...
                  {
                     _loc35_ = this.var_1.var_163[_loc32_];
                     if(_loc35_)
                     {
                  ...
                  if(_loc33_ != _loc15_)
                  {
                     ...
                     {
                        _loc36_ = _loc28_.getDefinition(_loc33_) as Class;
                        _loc37_ = new _loc36_();
                        if(_loc37_)
                        {
                  ...
                  if(_loc31_)
                  {
                     ...
                     {
                        _loc38_ = _loc28_.getDefinition(_loc15_) as Class;
                        _loc39_ = new _loc38_();
                        if(_loc39_)
                        {
               ...
               else if(_loc15_ == "a_DoorMarker")
               {
                  ...
                  _loc41_ = _loc14_.transform.concatenatedMatrix;
                  _loc9_ = _loc41_.tx;
                  _loc10_ = _loc41_.ty;
                  _loc8_ = _loc14_;
                  _loc14_.visible = const_30;
               ...
               {
                  _loc42_ = uint(int(_loc15_.substr(7)));
                  if(_loc42_)
                  {
                     ...
                     _loc45_ = class_11.method_545(this.internalName,_loc42_);
                     if(_loc45_)
                     {
               ...
               else if(!_loc15_.indexOf("a_DoorLocal_"))
               {
                  ...
                  if(_loc49_)
                  {
                     ...
                     _loc53_ = _loc14_ as MovieClip;
                     if(_loc53_.hasOwnProperty("bDisabled"))
                     {
      ...
      public function method_1130(param1:DisplayObject, param2:String, param3:Room, param4:Sprite) : void
      {
         ...
         var _loc16_:String = null;
         var _loc5_:a_Cue = param1 as a_Cue;
         _loc5_.entType = param2.slice(3);
         ...
         if(param2 == const_483)
         {
            ...
            {
               _loc10_ = _loc5_.characterName.split(",");
               if(_loc10_.length == 1)
               {
                  class_24.method_19(getQualifiedClassName(param4) + " " + const_483 + " must have characterName field in the form \'characterName,entType\', or \',entType\' if no characterName.");
               }
         ...
         var _loc7_:String = _loc5_.characterName;
         if(_loc7_)
         {
            _loc11_ = _loc5_.displayName == "Hidden";
            _loc12_ = class_14.var_999[_loc7_];
            if(_loc12_)
            {
         ...
         var _loc8_:EntType = EntType.method_48(_loc5_.entType);
         if(!_loc8_)
         {
         ...
         {
            _loc13_ = BehaviorType.method_367(_loc8_.var_562);
            if(!_loc13_.var_2117)
            {
               _loc5_.entType += "Hard";
      ...
      public function method_1003() : void
      {
         ...
         var _loc4_:uint = Math.round(_loc2_);
         if(_loc4_ != this.var_690)
         {
            this.method_528(_loc4_);
            var _loc11_:Packet = new Packet(LinkUpdater.const_791);
            _loc11_.method_9(this.var_690);
            this.var_1.serverConn.SendPacket(null);
         }
      ...
      public function method_682() : void
      {
         ...
         var _loc8_:Packet = new Packet(LinkUpdater.PKTTYPE_SET_LEVEL_COMPLETE);
         _loc8_.method_9(this.var_690);
      ...
      public function method_474(param1:String, param2:String) : void
      {
         ...
         {
            _loc7_ = this.var_1.method_111(_loc4_);
            if(_loc7_)
            {
      ...
      public function method_506(param1:String) : void
      {
         ...
         var _loc8_:LoaderInfo = ResourceManager.const_40[this.levelFileName];
         var _loc9_:ApplicationDomain = _loc8_.applicationDomain;
         if(_loc9_.hasDefinition(param1))
         {
            var _loc7_:Class = _loc9_.getDefinition(param1) as Class;
         }
      }
      ...
      private function method_264(param1:Sprite, param2:Room, param3:uint, param4:String, param5:String) : void
      {
         ...
         if((Boolean(_loc6_)) && !_loc6_.indexOf("am_"))
         {
            param4 = _loc6_;
         }
         var _loc7_:* = 0;
      ...
      public function method_194() : void
      {
         ...
         {
            _loc5_ = _loc4_.dObj as Sprite;
            if((Boolean(_loc5_)) && _loc5_.numChildren == 1)
            {
               _loc6_ = _loc5_.getChildAt(0) as MovieClip;
               if(_loc6_)
               {
                  _loc7_ = getQualifiedClassName(_loc6_);
                  if(!_loc7_.indexOf("a_Scaffolding_"))
                  {
                     _loc3_ = false;
                     if(_loc2_)
                     {
                        _loc8_ = _loc7_.split("_");
                        _loc9_ = _loc8_[2];
                        if(_loc9_ == _loc2_.type)
                        {
                           _loc3_ = true;
                        }
                     }
      ...
      public function method_735() : void
      {
         ...
         while(_loc1_ < this.var_811.length)
         {
            ...
            _loc6_ = _loc5_[_loc2_ + ":" + _loc9_.type + ":" + _loc9_.var_8];
            _loc11_ = int(_loc6_.indexOf(_loc9_));
            if(_loc11_ == -1)
            {
            ...
            else
            {
               ...
               _loc13_ = _loc12_.getChildByName("am_Holder" + _loc11_.toString()) as Sprite;
               if(_loc13_)
               {
                  if(_loc9_.var_8 == "L")
                  {
                     _loc14_ = _loc13_.getChildByName("am_LegendaryBack");
                     if(_loc14_)
                     {
                  ...
                  {
                     _loc14_ = _loc13_.getChildByName("am_RareBack");
                     if(_loc14_)
                     {
                        _loc14_.visible = true;
                     }
      ...
      public function method_663(param1:Boolean) : void
      {
         ...
         var _loc4_:uint = param1 ? const_1223 : const_1222;
         var _loc5_:uint = _loc4_ + const_1296;
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(param1)
            {
               var _loc3_:GfxType = class_6.method_1052(_loc6_);
            }
