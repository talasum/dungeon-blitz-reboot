package
{
   ...
   public class Entity
   {
      ...
      public static const MONSTER:uint = 2;
      
      public static const REMOTE:uint = 4;
      
      public static const LOCAL:uint = 8;
      
      public static const const_16:uint = 16;
      
      public static const const_241:uint = 32;
      ...
      private static const const_294:Boolean = true;
      ...
      public function Entity(param1:Game, param2:String, param3:a_Cue, param4:Number, param5:Number, param6:uint, param7:uint, param8:uint, param9:uint, param10:uint, param11:PowerType, param12:class_118, param13:String, param14:Vector.<class_87>, param15:class_87, param16:class_3)
      {
         ...
         if(this.method_355())
         {
            ...
            _loc24_ = const_282;
            _loc25_ = class_14.var_999[_loc23_];
            if(_loc25_)
            {
      ...
      public static function method_415(param1:String, param2:String) : String
      {
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            if(!_loc4_.toUpperCase().indexOf(_loc6_))
            {
               _loc3_ = _loc4_;
               break;
            }
      ...
      {
         var _loc2_:int = int(const_830.indexOf(param1));
         if(_loc2_ < 0)
         {
            _loc2_ = 0;
         }
      ...
      public function StartSkit(param1:String, param2:Boolean, param3:Entity) : void
      {
         ...
         if(param1 == "")
         {
            ...
            {
               _loc10_ = new Packet(LinkUpdater.const_451);
               _loc10_.method_9(this.id);
         ...
         param1 = _loc8_[int(Math.random() * _loc8_.length)];
      ...
      public function method_340(param1:Array, param2:class_146) : void
      {
         ...
         {
            _loc8_ = StringUtils.method_1611(_loc5_,"<",">");
            if(!_loc8_.indexOf("Goto"))
            {
         ...
         if(_loc5_)
         {
            _loc5_ = _loc5_.replace("#tn#",param2.targetName);
            _loc5_ = _loc5_.replace("#tc#",param2.targetClass);
            _loc5_ = this.method_1631(_loc5_,param2.var_2412);
            if(param2.bLocal)
            {
               this.var_1.screenChat.ReceiveChat(_loc4_ ? uint(0) : this.id,_loc5_,false);
            }
            else
            {
               _loc10_ = new Packet(LinkUpdater.const_451);
      ...
      public function DoEmote(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!param2)
         {
            ...
            {
               _loc4_ = new Packet(LinkUpdater.PKTTYPE_EMOTE_END);
               _loc4_.method_9(this.id);
      ...
      public function method_438(param1:String) : void
      {
         ...
         var _loc4_:class_26 = this.gfx.m_Seq.var_71.var_69[param1];
         if(_loc4_)
         {
            if(_loc3_.length > 1)
            {
      ...
      public function method_279(param1:String) : Point
      {
         ...
         var _loc4_:Point = _loc2_.var_780[_loc3_[0]][_loc3_[1]];
         if(!_loc4_)
         {
            return null;
         }
      ...
      public function method_1915(param1:uint, param2:class_64, param3:uint) : void
      {
         ...
         var _loc5_:class_114 = this.var_1.mOwnedCharms[param2.method_75()];
         if(!_loc5_ || !_loc4_ || !param3)
         {
            return;
         }
         if(!_loc5_.var_181)
         ...
         if(_loc7_)
         {
            _loc10_ = _loc7_.var_8 == class_64.const_196 || _loc7_.method_118() ? "L" : (_loc7_.var_8 == class_64.const_180 || _loc7_.method_124() ? "R" : "M");
      ...
      public function method_1437(param1:String) : void
      {
         ...
         var _loc3_:int = int(this.hudPowers.indexOf(_loc2_));
         if(_loc3_ >= 0)
         {
      ...
      private function method_1457() : void
      {
         ...
         if(!(this.var_20 & (PLAYER | const_16)))
         {
            ...
            {
               _loc10_ = class_14.powerTypesDict[_loc9_];
               if(_loc10_)
               {
         ...
         {
            _loc11_ = this.entType.equippedGear[_loc5_];
            _loc12_ = _loc11_ ? _loc11_.gearName : null;
            if(_loc12_)
            {
               _loc13_ = class_14.gearTypesDict[_loc12_];
               if(_loc13_)
               {
                  ...
                  _loc18_ = _loc13_.var_1197 ? class_14.magicTypesDict[_loc13_.var_1197] : null;
                  if(_loc18_)
                  {
                     _loc3_.push(_loc18_);
                  }
         ...
         if(this.var_1.mAbilityBook)
         {
            ...
            {
               _loc20_ = _loc19_ ? this.GetPowerFromAbilityType(_loc19_) : null;
               if(_loc20_)
               {
      ...
      public function method_1086() : void
      {
         ...
         {
            _loc7_ = class_14.powerTypesDict[_loc3_];
            if((Boolean(_loc7_)) && _loc1_ < EntType.const_238)
            {
         ...
         var _loc4_:Array = EntType.const_132[_loc2_.var_138];
         var _loc5_:uint = _loc4_ ? uint(_loc4_[this.var_64]) : uint(0);
      ...
      public function GetPowerFromAbilityType(param1:class_10) : PowerType
      {
         ...
         if(this.var_1.mAbilityBook)
         {
            var _loc2_:uint = uint(this.var_1.mAbilityBook.mAbilityListTrainedRanks[param1.abilityID]);
         }
         var _loc3_:String = param1.abilityName;
         var _loc4_:PowerType = class_14.powerTypesDict[_loc3_];
         if(!_loc4_)
         {
      ...
      public function method_1590() : void
      {
         ...
         if(this.var_549)
         {
            ...
            {
               _loc5_ = this.method_589();
               _loc5_.m_TheDO.x = this.gfx.m_TheDO.x;
         ...
         {
            _loc6_ = this.method_589();
            _loc6_.m_TheDO.x = this.gfx.var_166.m_TheDO.x;
      ...
      public function method_853() : void
      {
         ...
         if(this.var_1875)
         {
            if(!this.combatState.var_270)
            {
               _loc7_ = this.var_1897 / this.maxHP;
               if(_loc7_ >= this.entType.var_1336)
               {
         ...
         var _loc4_:Seq = this.gfx.m_Seq;
         _loc4_.var_1842 = this.var_549 ? 0.7 : 1;
         _loc4_.var_120 = _loc3_;
         var _loc5_:Boolean = Boolean(this.var_1.clientEnt) && Boolean(this.var_1.clientEnt.var_24) && this.var_1.PointOnScreenWithinDist(this.var_10,this.var_12,this.entType.width * 2,this.entType.height * 2);
         var _loc6_:Boolean = (_loc5_) && !this.method_503() && !this.var_822;
         ...
         if(this.entState == const_6 && !(this.var_20 & PLAYER) && !this.behaviorType.var_995 && !this.InActiveCutScene())
         {
            ...
            _loc11_ = (TIME_MONSTER_LAYS_DEAD_BEFORE_VANISHING - _loc10_) / MONSTER_FADE_TIME;
            if(_loc11_ < 1)
            {
         ...
         else if(this.gfx.var_615 < 1 || this.var_1.mTimeThisTick - this.var_1841 < const_835)
         {
            ...
            _loc13_ = 0.05 + _loc12_ / const_835;
            if(_loc13_ > 1)
            {
               _loc13_ = 1;
            }
         ...
         {
            _loc11_ = (MONSTER_FADE_TIME + this.var_1878 - this.var_1.mTimeThisTick) / (2 * MONSTER_FADE_TIME);
            if(_loc11_ < 1)
            {
               if(this.gfx.m_TheDO)
               {
      ...
      public function method_219(param1:Point, param2:String = "Shoot") : Point
      {
         ...
         var _loc4_:Dictionary = this.gfx.m_Seq.var_71.var_69;
         var _loc5_:class_26 = _loc4_[_loc3_];
         if(!_loc5_)
         {
            _loc5_ = _loc4_["Shoot"];
         }
         ...
         var _loc7_:class_28 = _loc5_.var_604[_loc6_];
         if(!_loc7_)
         {
            _loc7_ = _loc5_.method_242(_loc6_);
         }
         var _loc8_:Point = _loc7_.var_2381;
         if(!_loc8_)
         {
            return this.method_186(new Point());
         }
      ...
      {
         var _loc4_:class_8 = class_14.var_629[param1];
         if(_loc4_)
         {
            var _loc5_:class_76 = this.var_1.mOwnedMaterials[param1];
            if(!_loc5_)
            {
               _loc5_ = new class_76(0,_loc4_);
               this.var_1.mOwnedMaterials[param1] = null;
            }
            null.var_181 += param2;
            if(!param3)
            {
               ...
               this.var_1.screenNotification.ShowNotification(class_46.const_726,_loc4_.displayName + null,_loc4_.var_139,true,_loc4_.var_103);
            }
            this.var_1.screenArmory.Refresh();
         }
      }
      ...
      public function GainMount(param1:uint, param2:Boolean) : void
      {
         ...
         if(!param2)
         {
            var _loc4_:String = "Mount:" + _loc3_.var_566;
            this.var_1.screenNotification.ShowNotification(class_46.const_761,_loc3_.displayName,_loc3_.var_255,true,null,null);
         }
      }
      ...
      public function GainNewGear(param1:uint, param2:uint, param3:Boolean) : void
      {
         ...
         var _loc10_:uint = 0;
         var _loc5_:class_42 = this.var_1.mOwnedGear[param1];
         if(!_loc5_)
         {
         ...
         else
         {
            ...
            _loc10_ = uint(this.var_1.var_144.indexOf(_loc5_));
            if(_loc10_ <= -1)
            {
               return;
            }
      ...
      public function TakeDamage(param1:int, param2:Boolean, param3:Entity = null, param4:PowerType = null, param5:uint = 0) : void
      {
         ...
         if(param4)
         {
            ...
            if(Boolean(this.var_20 & LOCAL) && Boolean(param3))
            {
               ...
               if(!param4.bIsProjectile && !param4.var_301)
               {
                  ...
                  {
                     _loc15_ = this.combatState.method_135(class_14.buffTypesDict["Thorns"]);
                     if((Boolean(_loc15_)) && param1 > 0)
                     {
               ...
               {
                  _loc18_ = this.combatState.var_1032;
                  if(_loc18_)
                  {
            ...
            if(Boolean(this.var_20 & LOCAL) && Boolean(this.combatState.var_651))
            {
               ...
               _loc20_ = this.combatState.method_135(class_14.buffTypesDict["DetShield" + _loc19_]);
               if((Boolean(_loc20_)) && param1 > 0)
               {
                  ...
                  _loc23_ = new Packet(LinkUpdater.PKTTYPE_CHAR_REGEN);
                  _loc23_.method_9(this.id);
            ...
            if(param1 < 0)
            {
               ...
               if(param1 > 0)
               {
                  _loc25_ = this.combatState.method_135(class_14.buffTypesDict["Doomed"]);
                  if(_loc25_)
                  {
         ...
         _loc7_ = class_14.powerTypes[param5];
         if((Boolean(_loc7_)) && _loc7_.var_2900)
         {
            this.method_280();
         }
         else if(!param2)
         {
            _loc28_ = param3 && param4 && param3.var_353 != param4 && param3.var_280 != param4;
            _loc29_ = (_loc28_) && param4.var_301;
            _loc31_ = false;
            if(param1 < 0)
            {
               _loc30_ = 65280;
            ...
            else
            {
               ...
               else if(_loc28_)
               {
                  ...
                  _loc30_ = this.team == GOODGUY ? uint(16400195) : 16776977;
               }
               else
               {
                  this.var_596 = -this.var_596;
                  _loc30_ = this.team == GOODGUY ? uint(16400195) : 16750848;
               }
         ...
         else
         {
            ...
            _loc36_ = this.currHP < this.maxHP * 0.33;
            _loc37_ = (_loc36_) && this.var_2843;
            if(_loc37_)
            {
               this.var_2843 = false;
      ...
      public function method_1727() : void
      {
         ...
         {
            _loc5_ = uint(_loc4_);
            _loc6_ = this.var_1.GetEntFromID(_loc5_);
            if(!(!_loc6_ || !(_loc6_.var_20 & Entity.PLAYER)))
            {
               ...
               if(Boolean(this.currRoom) && _loc8_ < this.currRoom.var_1266)
               {
                  ...
                  _loc29_ = this.var_1.collMan.getFloorCollision(0,_loc7_,_loc8_,_loc27_,_loc28_,null,null,null,CollisionManager.HARD_FLOOR | CollisionManager.SOFT_FLOOR,0);
                  if(_loc29_)
                  {
                     _loc7_ = _loc28_.x;
               ...
               if(!this.var_2305)
               {
                  _loc30_ = this.var_64 + _loc6_.var_2384;
                  if(_loc30_ > MAX_CHAR_LEVEL)
                  {
                  ...
                  _loc9_ = Math.ceil(_loc9_ * (1 + _loc6_.totalMods.var_697));
                  if(_loc9_ > _loc32_)
                  {
                     _loc9_ = _loc32_;
                  }
                  ...
                  if(_loc33_ < _loc34_)
                  {
                     ...
                     _loc10_ = this.entType.var_1594 * MONSTER_GOLD_TABLE[_loc30_] * 0.5 * _loc3_ * _loc1_;
                     if(_loc10_ > _loc36_)
                     {
                        _loc10_ = _loc36_;
                     }
                  ...
                  if(Boolean(this.cue) && Boolean(this.cue.itemDrop))
                  {
                     ...
                     _loc42_ = _loc41_.split(",");
                     for each(_loc43_ in _loc42_)
                     {
                        if(!_loc43_.indexOf("Gold"))
                        {
                           _loc44_ = _loc43_.split("_");
                           _loc45_ = _loc44_.length <= 1 ? 1 : Number(_loc44_[1]);
                           _loc10_ = MONSTER_GOLD_TABLE[_loc37_] * 0.5 * _loc45_;
                        }
                        else if(!_loc43_.indexOf("Health"))
                        {
                           _loc46_ = _loc43_.split("_");
                           _loc47_ = _loc46_.length <= 1 ? 1 : Number(_loc46_[1]);
      ...
      public function method_1944(param1:Entity, param2:Number, param3:Number, param4:Boolean, param5:Boolean, param6:Number, param7:uint, param8:uint, param9:uint, param10:Number, param11:uint, param12:Boolean, param13:Boolean) : void
      {
         ...
         _loc14_ = new Packet(LinkUpdater.PKTTYPE_GRANT_REWARD);
         _loc14_.method_9(this.id);
      ...
      public function method_319(param1:uint, param2:uint) : void
      {
         ...
         _loc4_ = this.var_1.mOwnedGear[param2];
         if(_loc4_)
         {
      ...
      public function method_280() : void
      {
         ...
         _loc2_ = _loc1_ - this.var_1282;
         _loc3_ = this.var_78.am_HealthLevel;
         _loc4_ = 100 * (this.currHP / this.maxHP);
         if(_loc4_ > 100)
         {
            _loc4_ = 100;
         }
         ...
         if(_loc2_.var_573)
         {
            for each(_loc3_ in _loc2_.var_573)
            {
               ...
               else if(_loc5_ == "Badge")
               {
                  ...
                  {
                     _loc10_ = new Packet(LinkUpdater.const_1161);
                     _loc10_.method_26(_loc9_);
                     this.var_1.serverConn.SendPacket(_loc10_);
                  }
               }
      ...
      private function method_616(param1:Number) : Number
      {
         ...
         _loc3_ = param1 > 0 ? 1 : -1;
         _loc4_ = _loc3_ * param1 - _loc2_ * this.var_1.TIMESTEP;
         if(_loc4_ < 0)
         {
            _loc4_ = 0;
         }
      ...
      public function method_864() : void
      {
         ...
         if(this.entState != const_6)
         {
            ...
            if(!_loc3_)
            {
               ...
               if((this.var_1944 || this.bJumping) && !this.combatState.var_1313)
               {
                  if(this.currSurface)
                  {
                     _loc11_ = this.method_1039(this.currSurface);
            ...
            while(_loc12_)
            {
               ...
               if(!_loc13_)
               {
                  if(!_loc3_)
                  {
                     ...
                     _loc14_ = this.var_1.collMan.getFloorCollision(0,this.physPosX,this.physPosY,var_1190,var_1168,null,null,null,_loc1_,0);
                     if((Boolean(_loc14_)) && _loc14_ != this.currSurface)
                     {
         ...
         _loc4_ = _loc3_ || !this.currSurface;
         if(_loc4_)
         {
         ...
         if(!this.currSurface)
         {
            ...
            _loc15_ = this.var_1.collMan.getFloorCollision(0,this.physPosX,this.physPosY - const_781,var_226,var_407,null,null,null,CollisionManager.HARD_FLOOR,0);
            if((Boolean(_loc15_)) && var_226.length < var_52.length)
            {
               var_52.x = var_226.x;
               var_52.y = var_226.y;
               var_425.x = var_407.x;
         ...
         if(_loc6_)
         {
            ...
            _loc16_ = var_366.length - var_52.length;
            _loc16_ = _loc16_ + PULLBACK_DIST;
            var_52.x = 0;
            var_52.y = _loc16_;
            _loc7_ = true;
         }
         ...
         {
            _loc18_ = this.behaviorType.var_696;
            if(!_loc18_)
            {
               var_1443.x = 0;
         ...
         var_52.x *= 1.1;
         var_52.y *= 1.1;
         _loc8_ = this.var_1.collMan.getFloorCollision(0,this.startPhysPosX - var_52.x * 0.05,this.startPhysPosY - var_52.y * 0.05,var_52,var_425,null,null,null,CollisionManager.TRIGGER_BOUNDARY,0);
         if(_loc8_)
         {
            _loc19_ = new class_144();
            _loc19_.var_553 = _loc8_;
      ...
      public function method_1309() : void
      {
         ...
         _loc3_ = null;
         _loc4_ = this.triggersHit.length;
         if(_loc4_)
         {
            _loc3_ = null;
            _loc1_ = 0;
      ...
      public function method_529() : Boolean
      {
         ...
         if(this.var_24)
         {
            _loc4_ = int(this.mEquipGear[EntType.SWORD_SLOT]);
            if(!_loc4_)
            {
               return true;
            }
            _loc5_ = this.var_24.method_375(class_36.const_847);
            if(_loc5_.x >= this.appearPosX - _loc2_ && _loc5_.x <= this.appearPosX + _loc2_ && _loc5_.y <= this.appearPosY && _loc5_.y >= this.appearPosY - this.entType.height)
            {
               return true;
            }
         }
         ...
         for each(_loc3_ in this.var_1.level.var_264)
         {
            ...
            else
            {
               ...
               if(_loc3_.doorID)
               {
                  ...
                  {
                     _loc11_ = new Packet(LinkUpdater.PKTTYPE_REQUEST_DOOR_STATE);
                     _loc11_.method_9(_loc3_.doorID);
               ...
               {
                  _loc12_ = (this.var_10 - _loc8_) * (this.var_10 - _loc8_) + (this.var_12 - _loc9_) * (this.var_12 - _loc9_);
                  if(_loc12_ < _loc2_)
                  {
                     this.var_916 = _loc3_;
                     _loc2_ = _loc12_;
      ...
      public function method_579(param1:Door, param2:Boolean) : void
      {
         ...
         if(!_loc3_)
         {
            var _loc5_:* = const_974.indexOf(param1.var_1260) != -1;
            var _loc6_:String = Level.method_73(param1.var_1260);
            var _loc7_:MovieClip = null;
            var _loc8_:MovieClip = null;
            var _loc9_:Boolean = false;
            if(param1.doorState == Door.DOORSTATE_STATIC)
            {
               _loc7_ = class_4.method_16("a_DungeonDoorPlateTravel");
               _loc8_ = _loc7_.am_DoorPlate;
               _loc9_ = true;
            }
            else if(param1.doorState != Door.DOORSTATE_MISSIONREPEAT)
            {
               _loc7_ = class_4.method_16("a_DungeonDoorPlate");
               _loc8_ = _loc7_.am_DoorPlate;
            }
            else
            {
               _loc7_ = class_4.method_16("a_DungeonDoorPlateComplete");
               _loc8_ = _loc7_.am_DoorPlate;
               class_119.method_144(null.am_StarRating,param1.var_2671);
            }
            var _loc10_:String = "";
            var _loc11_:* = this.var_1.level.var_1550.indexOf("Hard") != -1;
            if(_loc11_)
            {
               null.am_DreadMode.visible = true;
            }
            else
            {
               null.am_DreadMode.visible = false;
               var _loc12_:MovieClip = null.am_FireGroup;
               var _loc13_:uint = uint(_loc12_.numChildren);
               var _loc14_:uint = 0;
               null.gotoAndStop(0);
               null.visible = false;
            }
            _loc10_ = "Dungeon";
            MathUtil.method_2(null.am_Header,null);
            MathUtil.method_2(null.am_MapName,null);
            null.x = param1.var_2280;
            null.y = param1.var_2285;
            _loc3_ = new class_33(this.var_1,null);
      ...
      public function method_1589(param1:Point, param2:Number, param3:Number) : void
      {
         ...
         for each(_loc17_ in this.var_1.entities)
         {
            if(!(!_loc17_.method_156() || _loc17_.method_503()))
            {
               ...
               _loc16_ = _loc17_.entType;
               _loc7_ = _loc16_.width * 0.5 + 100;
      ...
      public function method_1181(param1:Point, param2:Vector.<class_77>) : int
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            _loc6_ = _loc5_.rect.x + _loc5_.posX;
      ...
      public function method_1973(param1:Point) : Point
      {
         ...
         if(this.behaviorType.var_1267)
         {
            ...
            var _loc2_:Boolean = this.bFacingLeft();
      ...
      private function method_1656() : void
      {
         ...
         if(Boolean(this.var_1.level) && this.physPosY > this.var_1.level.var_1266)
         {
            ...
            if(this.cue)
            {
               ...
               {
                  _loc5_ = this.var_1.method_234(this.cue);
                  _loc1_ = _loc5_.x;
                  _loc2_ = _loc5_.y;
               }
            }
            ...
            _loc3_ = new Point();
            _loc4_ = this.var_1.collMan.getFloorCollision(0,_loc1_,_loc2_ - 19,new Point(0,120),_loc3_,null,null,null,CollisionManager.HARD_FLOOR | CollisionManager.SOFT_FLOOR,0);
            if(_loc4_)
            {
               _loc1_ = _loc3_.x;
         ...
         if(this.var_99)
         {
            ...
            if(this.entState == const_6)
            {
               if(!this.var_2760)
               {
                  ...
                  {
                     _loc3_ = this.var_1.GetEntFromID(this.summonerId);
                     _loc5_ = this.var_99 ? this.var_99.var_7 : 0;
                     _loc6_ = _loc5_ ? class_14.powerTypesDict["DecoyExplode" + _loc5_] : class_14.powerTypesDict["DecoyExplode"];
      ...
      public function method_1368(param1:Number) : void
      {
         ...
         if(Boolean(this.var_24) && this.var_1.mTimeThisTick - this.var_2832 >= 1000)
         {
            ...
            {
               _loc13_ = new Packet(LinkUpdater.const_1090);
               _loc13_.method_24(_loc7_);
      ...
      public function method_1948() : void
      {
         ...
         if(_loc2_.var_333)
         {
            _loc5_ = this.var_1.mBuildingInfo;
            if((Boolean(_loc5_)) && _loc5_.mStatus == class_105.const_521)
            {
               _loc5_.method_1421();
      ...
      public function method_2002(param1:EntType) : void
      {
         ...
         if(param1)
         {
            ...
            _loc7_ = this.var_183.gfx.m_Seq;
            _loc8_ = _loc7_.var_218;
      ...
      public function method_247(param1:Boolean, param2:Boolean, param3:int = 0) : void
      {
         ...
         else if(param1)
         {
            ...
            this.ResetEntType(this.entType);
            _loc7_ = this.gfx.m_Seq;
            _loc8_ = _loc7_.var_71.var_69;
            if(_loc8_["HeavyFall"])
            {
      ...
      public function method_262(param1:Boolean, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(this.combatState.var_39)
         {
            if(this.combatState.var_39 == class_14.powerTypesDict["HailstoneEmbrace1"].powerID && !param1)
            {
               ...
               this.ResetEntType(this.entType);
               _loc5_ = new GfxType();
               _loc5_.var_29 = "SFX_3.swf";
               _loc5_.bFireAndForget = true;
               _loc5_.animClass = "a_FrostArmorFallOff";
               _loc6_ = new SuperAnimInstance(this.var_1,_loc5_,true);
               _loc6_.m_TheDO.x = this.var_10;
      ...
      public function method_1494() : uint
      {
         ...
         _loc2_ = this.mExpLevel >= 10 ? uint(this.mExpLevel - 10) : uint(0);
      ...
      public function method_2054() : void
      {
         ...
         _loc1_ = this.mMasterClass ? class_9.method_472(this.mMasterClass) : uint(0);
      ...
      public function method_1828() : void
      {
         ...
         {
            _loc10_ = this.entType.equippedGear[_loc6_];
            _loc11_ = _loc10_ ? _loc10_.gearName : null;
            if(_loc11_)
            {
               _loc12_ = class_14.gearTypesDict[_loc11_];
               if(_loc12_)
               {
         ...
         _loc9_ = new Packet(LinkUpdater.const_900);
         _loc9_.method_24(this.var_64);
      ...
      private function method_1826() : void
      {
         ...
         if(this.entType.var_2241 && Boolean(this.var_20 & PLAYER))
         {
            ...
            {
               _loc9_ = this.hudPowers[_loc8_];
               if((Boolean(_loc9_)) && Boolean(_loc9_.var_2346))
               {
         ...
         if(this.var_494)
         {
            if(this.combatState.var_39 == class_14.powerTypesDict["HailstoneEmbrace1"].powerID)
            {
               this.entType.gfxType = this.entType.method_60();
               _loc7_ = this.entType.gfxType.customArts;
               _loc7_.push(new CustomArt("Gfx_Mage_1.swf","FrostArmor"));
            ...
            else if(this.combatState.var_39 == class_14.powerTypesDict["SeekingBlades1"].powerID)
            {
               this.entType.gfxType = this.entType.method_60();
               _loc7_ = this.entType.gfxType.customArts;
               _loc7_.push(new CustomArt("Gfx_Paladin_1.swf","SeekingBlades"));
            ...
            else if(this.combatState.var_39 == class_14.powerTypesDict["ShadowArmor1"].powerID)
            {
               this.entType.gfxType = this.entType.method_60();
               _loc7_ = this.entType.gfxType.customArts;
               _loc7_.push(new CustomArt("Gfx_Paladin_1.swf","Midnight"));
            ...
            else if(this.combatState.var_39 == class_14.powerTypesDict["Pyromania1"].powerID)
            {
               this.entType.gfxType = this.entType.method_60();
               _loc7_ = this.entType.gfxType.customArts;
               _loc7_.push(new CustomArt("Gfx_Mage_1.swf","FlameArmor"));
               if(this.entType.var_439 == "Male")
               {
         ...
         {
            var _loc10_:class_26 = this.gfx.m_Seq.var_71.var_69["SummonKO"];
            if(_loc10_)
            {
               this.gfx.m_Seq.var_800 = null;
            }
         ...
         {
            _loc10_ = this.gfx.m_Seq.var_71.var_69["Submerge"];
            if(_loc10_)
            {
               this.gfx.m_Seq.var_800 = null;
         ...
         if(this.cue)
         {
            var _loc5_:int = this.cue.groupSnapOffsetY;
         }
         else if(this.var_24)
         {
            _loc5_ = 0;
         ...
         if(_loc4_)
         {
            var _loc11_:BuffType = class_14.buffTypesDict["FrostShock"];
            if(this.combatState.var_1957)
            {
               this.gfx.method_627(null.var_932,null.var_1235);
               this.gfx.method_325(null.var_932,null.var_1235);
            }
         }
      }
      ...
      private function method_1442() : void
      {
         ...
         else
         {
            ...
            {
               _loc6_ = this.var_1.GetEntFromID(this.summonerId);
               if((Boolean(_loc6_)) && Boolean(_loc6_.mEquipPet))
               {
            ...
            else
            {
               ...
               _loc8_ = this.entType.baseLevel + this.var_1.level.var_2606;
               _loc9_ = _loc8_ - this.var_1.level.mapLevel;
               if(_loc9_ <= 0)
               {
                  _loc8_ += _loc7_;
               }
         ...
         if(Boolean(this.var_1.clientEntID) && this.var_1.clientEntID == this.id)
         {
            ...
            else if(this.var_868 != this.maxHP)
            {
               ...
               _loc12_ = new Packet(LinkUpdater.const_1127);
               _loc12_.method_24(_loc11_);
               ...
               if(this.currHP > this.maxHP)
               {
                  ...
                  _loc14_ = new Packet(LinkUpdater.PKTTYPE_CHAR_REGEN);
                  _loc14_.method_9(this.id);
