package
{
   ...
   public class Brain
   {
      ...
      private static const const_982:Boolean = true;
      ...
      public function method_356() : void
      {
         ...
         {
            _loc4_ = int(this.var_938[_loc1_]);
            if(_loc4_ > this.var_878)
            {
               var _loc5_:Entity = this.var_1.GetEntFromID(int(_loc1_));
               if(!_loc5_ || true || null.entState == Entity.const_6)
               {
      ...
      public function AddHate(param1:Entity, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 && param1.behaviorType && Boolean(param1.summonerId))
         {
            ...
            {
               _loc7_ = this.var_1.GetEntFromID(param1.summonerId);
               if((Boolean(_loc7_)) && !_loc7_.summonerId)
               {
         ...
         for(; _loc5_ < _loc3_; _loc5_++)
         {
            ...
            if(_loc1_.method_414(_loc2_))
            {
               ...
               else if(_loc2_.var_6 == PowerType.TARGETMETHOD_MELEE || _loc2_.var_6 == PowerType.const_46)
               {
                  ...
                  _loc6_ = this.e.GetMeleePower();
                  _loc7_ = _loc6_ ? _loc6_.method_63(this.e) : 0;
      ...
      public function Think() : void
      {
         ...
         {
            _loc4_ = this.var_1.GetEntFromID(this.e.summonerId);
            if(_loc4_)
            {
         ...
         {
            _loc7_ = Boolean(this.mostHatedEnt) && Boolean(this.e.var_2749 & Flags.CANCEL_ON_AGGRO) && !this.e.InActiveCutScene();
            _loc8_ = (_loc7_) || this.CloseEnoughToStop(this.e.velocity.x,this.e.physPosX,this.e.gotoLocationX);
            if(_loc8_)
            {
               this.e.bRunning = false;
            }
